...
$container['notFoundHandler'] = function ($container) use ($app) {
    return function ($request, $response) use ($container, $app) {
        return  $container['view']->render($response, 'templates/error.twig', []);
    };
};
